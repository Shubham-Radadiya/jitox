...
/** Dedicated Target & Incentive module payload (demo structure; replace with DB when models exist). */
export const getTargetIncentive = async (_req: Request, res: Response) => {
  try {
    ...
    console.error("getTargetIncentive", e);
